        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-8 items-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              أستاذ / مرماح عبدالحميد علي
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-8">
              خطوة صغيرة دلوقتي ممكن تغيّر مستقبلك كله.
            </p>
            ...
            {[
              {
                ...
                testimonial: "تجربة رائعة مع الأستاذ مرماح، شرح مميز وطريقة سهلة في توصيل المعلومة"
              },
              {
                name: "سيف طارق",
