          ...
          return (
            <div
              ...
              className={cn(
                ...
                isCompleted && !isSelected && "text-sky-600"
              )}
            ...
            >
              ...
              <span className="rtl:text-right ltr:text-left flex-grow mr-1">
                {content.title}
                {content.type === 'quiz' && (
                  <span className="ml-2 text-xs text-sky-600">(اختبار)</span>
                )}
              </span>
              {content.type === 'chapter' && content.isFree && (
                <span className="ml-4 px-2 py-0.5 text-xs font-semibold bg-sky-100 text-sky-800 rounded-full">
                  مجاني
                </span>
              )}
            </div>
