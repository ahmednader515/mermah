  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">خطوة صغيرة دلوقتي ممكن تغيّر مستقبلك كله.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-gradient-to-r from-sky-400 to-sky-600 rounded-xl p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sky-100 text-sm">الرصيد الحالي</p>
              <p className="text-2xl font-bold">{user?.balance?.toFixed(2) || "0.00"} جنيه</p>
            </div>
            <Wallet className="h-8 w-8 text-sky-200" />
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-sky-400 to-sky-600 rounded-xl p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sky-100 text-sm">الكورسات المشتراة</p>
              <p className="text-2xl font-bold">{studentStats.totalCourses}</p>
            </div>
            <BookOpenIcon className="h-8 w-8 text-sky-200" />
          </div>
        </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <div className="w-full bg-gray-200 rounded-full h-3">
                        <div 
                          className="bg-gradient-to-r from-sky-400 to-sky-600 h-3 rounded-full transition-all duration-300"
                  ...
                  <Button 
                    className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-3 text-base transition-all duration-200 hover:scale-105" 
                    variant="default"
                    asChild
                  >
