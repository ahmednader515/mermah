          ...
          <Card className="border-sky-200 bg-sky-50 dark:bg-sky-950/20">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label className="text-sm font-medium text-sky-700 dark:text-sky-300">الاسم الكامل</Label>
                  <p className="text-sky-800 dark:text-sky-200 font-semibold">{createdUser.fullName}</p>
                </div>
                <div>
                  <Label className="text-sm font-medium text-sky-700 dark:text-sky-300">رقم الهاتف</Label>
                  <p className="text-sky-800 dark:text-sky-200 font-semibold">{createdUser.phoneNumber}</p>
                </div>
              </div>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {formData.password && formData.confirmPassword && (
                  <div className={`text-sm ${passwordChecks.match ? 'text-sky-600' : 'text-red-600'}`}>
