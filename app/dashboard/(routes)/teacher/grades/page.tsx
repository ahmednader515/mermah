...
const GradesPage = () => {
    ...
    const getGradeColor = (percentage: number) => {
        ...
        if (percentage >= 70) return "text-sky-500";
        if (percentage >= 60) return "text-orange-600";
        return "text-red-600";
    };

    const getGradeBadge = (percentage: number) => {
        if (percentage >= 90) return { variant: "default" as const, className: "bg-sky-700 text-white" };
        if (percentage >= 80) return { variant: "default" as const, className: "bg-sky-600 text-white" };
        if (percentage >= 70) return { variant: "default" as const, className: "bg-sky-500 text-white" };
                                            ...
                                            <div key={answer.questionId} className="border rounded-lg p-4">
                                                ...
                                                <div className="grid grid-cols-2 gap-4 text-sm">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-sky-600">{answer.correctAnswer}</p>
                                                    </div>
                                                </div>
